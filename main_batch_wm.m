...
%######################## set parameters #######################%
Cfg.TimePoints=1200; % set number of TRs
Cfg.TR=6; % set TR
Cfg.SliceTiming.SliceNumber=91; % set number of slices
Cfg.SliceTiming.SliceOrder=[1:2:91 2:2:91]; % set slice order
Cfg.SliceTiming.ReferenceSlice=90; % set reference slice
wmthresh=0.50; % set white matter mask thresheold
